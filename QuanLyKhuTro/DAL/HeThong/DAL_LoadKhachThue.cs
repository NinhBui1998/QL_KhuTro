   ...
   public class DAL_LoadKhachThue
    {
        ...
        public List<KhachThue> loadkhachthueChuadktt()
        {
            var kq1 = from kt in data.KHACHTHUEs
                      from p in data.PHONGs
                      from kp in data.KHACHTHUEPHONGs
                      where kt.MAKT == kp.MAKT && kp.MAPHONG == p.MAPHONG && kt.TINHTRANGTAMTRU=="chưa đăng ký"
                      select new
                      {
                          kt.MAKT,
                          kt.TENKT,
        ...
        public List<KhachThue> loadkhachthuesaptoihan()
        {
            var kq1 = from kt in data.KHACHTHUEs
                      from p in data.PHONGs
                      from kp in data.KHACHTHUEPHONGs
                      where kt.MAKT == kp.MAKT && kp.MAPHONG == p.MAPHONG && kt.TINHTRANGTAMTRU == "Sắp hết hạn đăng ký"
                      select new
                      {
                          kt.MAKT,
                          kt.TENKT,
