...
{
    public partial class frm_phongtrong : Form
    {
        ...
        {
            grv_tkphong.DataSource = bll_tkp.loadphongtrong();
            txt_tongphong.Text = bll_dsp.tongphongtrong();
        }
        ...
        private void simpleButton3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                row1_TieuDe_ThongKeSanPham.Value2 = "Danh sách phòng trống";
