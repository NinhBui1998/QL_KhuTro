...
namespace QuanLyKhuTro.user_thongke
{
    ...
    public partial class frm_tongphong : Form
    {
        BLL_ThongKePhong bll_tkp = new BLL_ThongKePhong();
        BLL_DSPhong bll_dsp = new BLL_DSPhong();
        public frm_tongphong()
        {
            InitializeComponent();
        }

        private void frm_tongphong_Load(object sender, EventArgs e)
        {
            grv_tkphong.DataSource = bll_tkp.loadphong();
            txt_tongphong.Text = bll_tkp.tongphong();
        }
        ...
        private void simpleButton3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string saveExcelFile = @"E:\DA_TotNghiep\GitHub\QL_KhuTro\ThongKe_tongphong.xlsx";
                string folderPath = @"E:\DA_TotNghiep\GitHub\QL_KhuTro\ThongKe_tongphong.xlsx";
                ...
                if (folderBrowser.ShowDialog() == DialogResult.OK)
                {
                    ...
                    var fileCount = (from file in Directory.EnumerateFiles(folderPath, "*.xlsx", SearchOption.AllDirectories)
                                     select file).Count();
                    var s = fileCount + 1;
                    saveExcelFile = folderPath + "\\ThongKe_tongphong" + s + "_" + a + "_" + b + "_" + c + ".xlsx";
                ...
                Range row1_TieuDe_ThongKeSanPham = ws.get_Range("A1", "H1");
                ...
                row1_TieuDe_ThongKeSanPham.Value2 = "Danh sách phòng";
